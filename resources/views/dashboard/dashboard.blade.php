                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="col-span-12 lg:col-span-6 mt-8">
                                    ...
                                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                                        ...
                                        <div class="report-chart">
                                            <div class="h-[275px]">
                                                <canvas id="report-line-chart" class="mt-6 -mb-6" width="363" height="220" style="display: block; box-sizing: border-box; height: 275px; width: 453.75px;"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                                    ...
                                    <div class="intro-y box p-5 mt-5">
                                        <div class="mt-3">
                                            <div class="h-[213px]">
                                                <canvas id="report-pie-chart" width="162" height="170" style="display: block; box-sizing: border-box; height: 212.5px; width: 202.5px;"></canvas>
                                            </div>
                                        </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                                    ...
                                    <div class="intro-y box p-5 mt-5">
                                        <div class="mt-3">
                                            <div class="h-[213px]">
                                                <canvas id="report-donut-chart" width="162" height="170" style="display: block; box-sizing: border-box; height: 212.5px; width: 202.5px;"></canvas>
                                            </div>
                                        </div>
                                        <div class="w-52 sm:w-auto mx-auto mt-8">
                                            <div class="flex items-center">
                                ...
                                <div class="col-span-12 grid grid-cols-12 gap-6 mt-8">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                                        <div class="box p-5 zoom-in">
                                            ...
                                            <div class="mt-1">
                                                <div class="h-[58px]">
                                                    <canvas class="simple-line-chart-1 -ml-1" width="365" height="46" style="display: block; box-sizing: border-box; height: 57.5px; width: 456.25px;"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-span-12 sm:col-span-6 2xl:col-span-3 intro-y">
                                        <div class="box p-5 zoom-in">
                                            <div class="flex items-center">
                                                ...
                                                <div class="flex-none ml-auto relative">
                                                    <div class="w-[90px] h-[90px]">
                                                        <canvas id="report-donut-chart-2" width="72" height="72" style="display: block; box-sizing: border-box; height: 90px; width: 90px;"></canvas>
                                                    </div>
                                        ...
                                        <div class="mt-5 intro-x">
                                            <div class="box zoom-in">
                                                <div class="tns-outer" id="important-notes-ow"><button type="button" data-action="stop"><span class="tns-visually-hidden">stop animation</span>stop</button><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">4</span>  of 3</div><div id="important-notes-mw" class="tns-ovh"><div class="tns-inner" id="important-notes-iw"><div class="tiny-slider  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="important-notes" style="transform: translate3d(-60%, 0px, 0px);"><div class="p-5 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                                    ...
                                                    <div class="p-5 tns-item tns-slide-active" id="important-notes-item2">
                                                        <div class="text-base font-medium truncate">Lorem Ipsum is simply dummy text</div>
                                                        <div class="text-slate-400 mt-1">20 Hours ago</div>
                                                        <div class="text-slate-500 text-justify mt-1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</div>
                                                        <div class="font-medium flex mt-5">
