...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-primary shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#add-position-modal">Add New Position</button>
        <div class="hidden md:block mx-auto text-slate-500">Showing {{ $positions->count() }} positions</div>
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <div class="w-56 relative text-slate-500">
                <input type="text" class="form-control w-56 box pr-10" placeholder="Search..." id="search-positions">
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    <th class="whitespace-nowrap">POSITION NAME</th>
            ...
            <tbody id="positions-table-body">
                ...
                <tr class="intro-x">
                    ...
                    <td class="text-center">
                        <div class="flex items-center justify-center {{ $position->status === 'active' ? 'text-success' : 'text-danger' }}">
                    ...
                    <td class="text-center">{{ $position->created_at->format('M d, Y') }}</td>
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center py-8 text-slate-500">No positions found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<div id="add-position-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- BEGIN: Modal Header -->
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Add New Position</h2>
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12">
                    ...
                    <input id="position_name" type="text" class="form-control" placeholder="Enter position name" required>
                    <div class="text-danger text-xs mt-1" id="position_name_error"></div>
                </div>
                <div class="col-span-12">
                    <label for="description" class="form-label">Description</label>
                    <textarea id="description" class="form-control" placeholder="Enter position description" rows="3"></textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary w-20" onclick="savePosition()">Save</button>
            </div>
            <!-- END: Modal Footer -->
        </div>
    </div>
...
<div id="edit-position-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- BEGIN: Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12">
                    ...
                    <input id="edit_position_name" type="text" class="form-control" placeholder="Enter position name" required>
                    <div class="text-danger text-xs mt-1" id="edit_position_name_error"></div>
                </div>
                <div class="col-span-12">
                    <label for="edit_description" class="form-label">Description</label>
                    <textarea id="edit_description" class="form-control" placeholder="Enter position description" rows="3"></textarea>
            ...
            <div class="modal-footer">
                <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Cancel</button>
                <button type="button" class="btn btn-primary w-20" onclick="updatePosition()">Update</button>
            </div>
            <!-- END: Modal Footer -->
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    ...
                    <div class="text-slate-500 mt-2">Do you really want to delete this position? <br>This process cannot be undone.</div>
                </div>
...
<x-notification-toast 
    ...
    type="info" 
    title="Information" 
    message="Position management system is ready" 
    :showButton="false" 
    :autoHide="true" 
    :duration="4000" 
    position="right" 
...
@push('scripts')
    <script src="{{ asset('js/position-management/position-management.js') }}"></script>
@endpush